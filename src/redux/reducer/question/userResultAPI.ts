...
export const getUserResult = async (userId: string, testId: string, type: string): Promise<any> => {
  try {
...
export const createNewUserResult = async (userId: string, testId: string, type: string): Promise<any> => {
  try {
...
export const updateUserResult = async (userResultId: string, answers: any, isSubmitted: boolean, score: number): Promise<any> => {
  try {
...
export const getUserResultAPI = createAsyncThunk(
    ...
    async ({userId, testId, type }: { userId:string, testId: string, type: string }, { rejectWithValue }) => {
      try {
